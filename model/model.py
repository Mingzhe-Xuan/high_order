...
class Model(nn.Module):
    def __init__(
        ...
        irreps_list: Union[List[str], List[Irreps], None] = None,
    ):
        super(Model, self).__init__()
    ...
    def forward(self, atom_type, edge_vec, edge_index, batch_index):
        ...
        for invariant_layer in self.invariant_layers:
            atom_feature, edge_feature = invariant_layer(atom_feature, edge_feature, edge_index)
        ...
        for equivariant_layer in self.equivariant_layers:
            atom_feature, edge_feature = equivariant_layer(atom_feature, edge_vec, edge_index, edge_feature)
